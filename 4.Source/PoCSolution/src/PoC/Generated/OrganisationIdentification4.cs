...
public class OrganisationIdentification4
{
	...
	[System.ComponentModel.DataAnnotations.RegularExpression(@"[A-Z]{6,6}[A-Z2-9][A-NP-Z0-9]([A-Z0-9]{3,3}){0,1}", ErrorMessage = "Invalid format of field BICOrBEI (xmlTag: BICOrBEI). It did not adhere to pattern: \""+@"[A-Z]{6,6}[A-Z2-9][A-NP-Z0-9]([A-Z0-9]{3,3}){0,1}"+"\"")]
