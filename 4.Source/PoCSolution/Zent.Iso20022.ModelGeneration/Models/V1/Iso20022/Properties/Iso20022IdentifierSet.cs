...
namespace Zent.Iso20022.ModelGeneration.Model.V1.Iso20022.Properties;

public class Iso20022IdentifierSet : SimplePropertyObject
{
    ...
    {
        return new Iso20022IdentifierSet
        {
