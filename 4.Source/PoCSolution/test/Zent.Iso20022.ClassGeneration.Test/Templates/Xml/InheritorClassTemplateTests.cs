...
[Collection("UnitTest")]
public partial class InheritorClassTemplateTests
{
    private readonly ITestOutputHelper output;

    private const string BaseClassName = "MyParentClass";
...
{"\t"}/// </summary>";
    ...
    private const string AssertClassLine = $"public partial class {ClassName} : {BaseClassName}";
...
{"\t"}{AssertPropertyDLine}
    ...
    public InheritorClassTemplateTests(ITestOutputHelper output)
    {
        this.output = output;
    }
    ...
    [Fact]
    public void GivenSimpleExampleWithProperties_WhenTransformingInheritorClassTemplate_ThenPayloadIsAsExpected()
    {
        // Arrange
        var mockedClass = new InheritorClassElement
        {
