...
public class AccountIdentification4Choice
{
	...
	[RegularExpression(@"[A-Z]{2,2}[0-9]{2,2}[a-zA-Z0-9]{1,30}", ErrorMessage = "Invalid format of field IBAN (xmlTag: IBAN). It did not adhere to pattern: \"[A-Z]{2,2}[0-9]{2,2}[a-zA-Z0-9]{1,30}\"")]
