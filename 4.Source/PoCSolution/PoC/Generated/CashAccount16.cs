...
public class CashAccount16
{
	...
	/// <summary>
	/// Identification of the currency in which the account is held.   <br/>
	///   <br/>
	/// Usage: Currency should only be used in case one and the same account number covers several currencies  <br/>
	...
	/// <summary>
	/// Name of the account, as assigned by the account servicing institution, in agreement with the account owner in order to provide an additional means of identification of the account.  <br/>
	///   <br/>
